...
const EmergencyModal = (props) => {
  ...
  const visible = useMemo(() => VinMessage?.remoteScramFlag === 1, [VinMessage?.remoteScramFlag])
  ...
  // 解除制动 
  function onConfirm () {
    props.dispatch(action('nativeMessageModal/sendComandToNative', { command: "sendUnScramCommand" }));
  }
          ...
          <View>
            ...
            <View style={styles.buttonsContainer}>
              <TouchableOpacity style={styles.button} onPress={onConfirm}>
                <Text style={styles.buttonText}>解除制动</Text>
              </TouchableOpacity>

              <TouchableOpacity style={[styles.button, styles.manual]} onPress={onSwitchToManual}>
                <Text style={[styles.buttonText, styles.manualText]}>人工驾驶</Text>
              </TouchableOpacity>
            </View>
          </View>
