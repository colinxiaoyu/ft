...
const JobStaticesDispatch = (props) => {
    ...
    {showTask && <LinearGradient
      ...
      <View style={styles.status1}>
        <View style={styles.status1Item}>
          <Text style={styles.text26}>{vehDetailVO?.estMileage} <Text style={styles.text16}>m</Text></Text>
        ...
        <View style={styles.status1Item}>
          <Text style={styles.text26}>{vehDetailVO?.estGoTime} <Text style={styles.text16}>min</Text></Text>
          <View style={styles.status1Bottom}>
            <Image source={require('../assets/icon_info_time.png')} style={styles.status1BottomImg} />
            <Text style={styles.text20}>预计行驶时长</Text>
          </View>
        </View>
      </View>
...
export default JobStaticesDispatch
